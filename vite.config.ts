...
export default defineConfig({
  server: {
    ...
    fs: {
      strict: true,
      // node_modules is symlinked to /var/lib/site-node_modules because /home is
      // a small (300M) virtiofs and the app's deps exceed it; the dev server
      // resolves symlinks to their realpath, so that realpath must be allowed.
      allow: [import.meta.dirname, "/var/lib/site-node_modules"],
